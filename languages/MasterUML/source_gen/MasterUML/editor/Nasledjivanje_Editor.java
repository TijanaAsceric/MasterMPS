...
public class Nasledjivanje_Editor extends DefaultNodeEditor {
  public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
    return this.createCollection_ou84j0_a(editorContext, node);
  }
  private EditorCell createCollection_ou84j0_a(EditorContext editorContext, SNode node) {
    EditorCell_Collection editorCell = EditorCell_Collection.createHorizontal(editorContext, node);
    editorCell.setCellId("Collection_ou84j0_a");
  ...
  private EditorCell createConstant_ou84j0_a0(EditorContext editorContext, SNode node) {
    EditorCell_Constant editorCell = new EditorCell_Constant(editorContext, node, "Nasledjivanje:");
    editorCell.setCellId("Constant_ou84j0_a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createRefCell_ou84j0_b0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefCellCellProvider(node, editorContext);
    provider.setRole("pocetak");
    provider.setNoTargetText("<no pocetak>");
    EditorCell editorCell;
    provider.setAuxiliaryCellProvider(new Nasledjivanje_Editor._Inline_ou84j0_a1a());
  ...
  public static class _Inline_ou84j0_a1a extends InlineCellProvider {
    public _Inline_ou84j0_a1a() {
      super();
    }
    ...
    public EditorCell createEditorCell(EditorContext editorContext, SNode node) {
      return this.createProperty_ou84j0_a0b0(editorContext, node);
    }
    private EditorCell createProperty_ou84j0_a0b0(EditorContext editorContext, SNode node) {
